            ...
            <div class="row" style="margin-bottom:5px;">
                <div class="col-sm-12 col-md-12 col-lg-12 text-center ">
                     <div style="margin-top:25px;" align="center">
                        <span style="font-size:18px;margin-top:2px;font-weight: bold;color:#777777;padding-left:4%;float:left">ผลจากการค้นหาคำว่า "<?php echo $search ;?>" พบ <?php echo count($events);?> รายการ </span>
...
<script type="text/javascript">
    function orderBy(order){
        ...
        $.ajax({
              type: "POST",
                  url: "<?php echo base_url();?>event/search_order",
                  data: {search_events:search,orderby:order},
                  cache : false,
