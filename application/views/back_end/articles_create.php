            ...
            <div class="card-block">
                    <div class="form-group">
                        <label class="col-md-12">ชื่อหัวข้อ *</label>
                            <div class="col-md-12">
                            <input id="articles_name" name="articles_name" type="text" placeholder="กรุณากรอกชื่อหัวข้อ" class="form-control form-control-line" value="">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="col-md-12">Tag หรือ Keyword </label>
                            <div class="col-md-12">
                            <input id="articles_tag" name="articles_tag" type="text" class="form-control form-control-line" data-role="tagsinput" value="">
                            <br/>
...
function chk_form(){
    ...
    if($("#articles_picture").get(0).files.length == 0){
          $("#msg-2").show();
          chk = false;
    }
    if(chk){
