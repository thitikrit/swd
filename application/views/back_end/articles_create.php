...
<div class="row page-titles">
    <div class="col-md-6 col-8 align-self-center">
        <h3 class="text-themecolor m-b-0 m-t-0">สร้างบทความ</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Admin</a></li>
            <li class="breadcrumb-item">บทความ</li>
            <li class="breadcrumb-item active">สร้างบทความ</li>
        </ol>
    </div>
</div>
<!-- ============================================================== -->
...
<!-- Start Page Content -->
<!-- ============================================================== -->
<form id="articles_form" name="articles_form" method="post" action="<?php echo base_url();?>index.php/manage_articles/add"  enctype="multipart/form-data">
<div class="row">
    <!-- Column -->
            ...
            <div class="card-block">
                    <div class="form-group">
                        <label class="col-md-12">ชื่อ</label>
                            <div class="col-md-12">
                            <input id="articles_name" name="articles_name" type="text" placeholder="กรุณากรอกชื่อ" class="form-control form-control-line" value="">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="col-md-12">แท็ก</label>
                            <div class="col-md-12">
                            <input id="articles_tag" name="articles_tag" type="text" class="form-control form-control-line" value="">
                        </div>
                    </div> 
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-block">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea id="articles_sub_detail" style="height:100px" name="articles_sub_detail" type="text" class="form-control form-control-line"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">รายละเอียด</label>
                        <div class="col-md-12">
                            <textarea id="articles_detail" name="articles_detail"></textarea>
                        </div>
                    </div>
            </div>
        </div>
