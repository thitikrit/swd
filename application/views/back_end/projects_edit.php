...
<form id="projects_form" name="projects_form" method="post" action="<?php echo base_url();?>index.php/manage_projects/update"  enctype="multipart/form-data">
<div class="row">
    <!-- Column -->
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="col-md-12">แท็ก</label>
                            <div class="col-md-12">
                            <input id="projects_tag" name="projects_tag" type="text" class="form-control form-control-line" value="<?php echo $val['projects_tag'];?>">
                        </div>
                    </div> 
                     <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <select class="form-control form-control-line" id="projects_status" name="projects_status">
                                ...
                                <option value="CANCEL" <?php if($val['projects_status'] == 'CANCEL'){ echo 'selected'; } ?>>ยกเลิกการเผยแพร่</option>
                            </select>
                        </div>
                    </div>
            </div>
                            ...
                            <?php if($plans != NULL){ ?>
                                ...
                                <?php foreach($plans as $val2){ ?>
                                    ...
                                    <td width="25%">
                                        ...
                                        <input type="file" name="plans_picture[]" style="width:100%" class="form-control" accept=".jpg, .jpeg, .png">
                                    ...
                                    <?php $plans_gallery = json_decode($val2['plans_gallery']);?>
                                        ...
                                        <div class="col-12" id="div-add-plans-gal-<?php echo $num_plan_gal; ?>" style="padding:0px;padding-bottom: 10px">
                                            ...
                                            <input type="file" name="plans_gallery[<?php echo $num_plans; ?>][]" style="width:100%" class="form-control" accept=".jpg, .jpeg, .png">
                                ...
                                for($i = 0 ; $i < count($slide);$i++){ ?>
                                    <tr id="tr-pic-slide-<?php echo $i; ?>">
                                        <td width="50%">
                                            ...
                                            <input type="file" name="menu_pic_slide[]" style="width:100%" class="form-control" accept=".jpg, .jpeg, .png ">
...
function add_picture_slide(){
    ...
    new_picture_slide +='<td width="50%"><input type="file" name="menu_pic_slide[]" style="width:100%" class="form-control" accept=".jpg, .jpeg, .png "></td>';
