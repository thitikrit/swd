...
<form id="events_form" name="events_form" method="post" action="<?php echo base_url();?>index.php/manage_events/update"  enctype="multipart/form-data">
<div class="row">
    <!-- Column -->
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="col-md-12">แท็ก</label>
                            <div class="col-md-12">
                            <input id="events_tag" name="events_tag" type="text" class="form-control form-control-line" value="<?php echo $val['events_tag'];?>">
                        </div>
                    </div> 
            </div>
        </div>
    ...
    <div class="col-lg-12 col-xlg-12 col-md-12 text-center"> 
        ...
        <a href="<?php echo base_url(); ?>index.php/manage_events" class="btn btn-warning" style="position:absolute;left:15px;">ย้อนกลับ</a>
    </div>
    <br/>
</div>
<!-- Row -->
